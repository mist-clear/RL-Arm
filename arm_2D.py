...
class Arm_2D(gym.Env):
    ...
    def __init__(self):
            ...
            self.target_pos = self.generate_random_pos()    # randomly generated target
    ...
    # generate random position of the targets 
    ...
    def step(self, action):
        ...
        # the arm is looking for the goal, PnP_action is 1 now
            ...
            if (dis_err_goal > -close_enough_goal and dis_err_goal < close_enough_goal): 
                ...
                self.target_pos = self.generate_random_pos()    # generate new target 
        ...
        if self.current_score <= -50 or self.current_score >= 50: 
            done = True
        else:
            done = False
